;;; my-doom-dracula-theme.el --- doom-dracula, with upstream Dracula syntax colors -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Based on: doom-dracula-theme.el (Added: March 8, 2018 (1337e9b2c4bb))
;;           Author: fuxialexander <https://github.com/fuxialexander>
;;           Maintainer: hlissner <https://github.com/hlissner>
;; Font-lock/web-mode colors and attributes (bold/italic/etc) for
;; source-code buffers are taken from the upstream dracula-theme.el package
;; (https://github.com/dracula/emacs) instead of doom-dracula's own choices.
;; All other faces (dired, diff, completion, org, markdown, helm, modeline,
;; etc.) are unchanged from doom-dracula-theme.el.
;;
;;; Commentary:
;;; Code:
...
(defgroup my-doom-dracula-theme nil
  "Options for the `my-doom-dracula' theme."
  :group 'doom-themes)

(defcustom my-doom-dracula-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'my-doom-dracula-theme
  :type 'boolean)

(defcustom my-doom-dracula-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'my-doom-dracula-theme
  :type 'boolean)

(defcustom my-doom-dracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'my-doom-dracula-theme
  :type 'boolean)

(defcustom my-doom-dracula-comment-bg my-doom-dracula-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'my-doom-dracula-theme
  :type 'boolean)

(defcustom my-doom-dracula-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme my-doom-dracula
  "A dark theme based on Dracula theme, using upstream dracula-theme.el
colors/attributes for source-code (font-lock) faces"
  ...
  ((bg         '("#282a36" "#262626" "black"        ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if my-doom-dracula-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if my-doom-dracula-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if my-doom-dracula-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if my-doom-dracula-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if my-doom-dracula-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if my-doom-dracula-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if my-doom-dracula-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if my-doom-dracula-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if my-doom-dracula-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright my-doom-dracula-brighter-modeline)
   (-modeline-pad
    (when my-doom-dracula-padded-modeline
      (if (integerp my-doom-dracula-padded-modeline) my-doom-dracula-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if my-doom-dracula-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
   ...
   ;;;; font-lock (source-code syntax; mirrors dracula-theme.el)
   (font-lock-builtin-face :foreground cyan :slant 'italic)
   ...
   (font-lock-type-face :foreground cyan :slant 'italic)
   (font-lock-variable-name-face :foreground fg :weight 'bold)
   (font-lock-warning-face :foreground orange :background base2)
   ...
   ;;;; web-mode (source-code; mirrors dracula-theme.el)
...
;;; my-doom-dracula-theme.el ends here
